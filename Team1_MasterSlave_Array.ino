      ...
      {        
        ...
        if (MASTERswitchSTATE == 0) 
        ...
        else if (MASTERswitchSTATE == 1)
          {
            ...
            Wire.beginTransmission(Z_MOTION);  //beginning transmission to z_slave
            char header = 'a';     
            ...
            int coord_arr[] = {240,1800,100,3200}; 
            ...
            //will need to match this up timing wise with coordinate
            //may need to think about request event from z, so that it 
